...
public partial class Queen : Node2D, IPiece
{
    ...
    public static Queen Load(Player owner, Vector2I position)
    {

        Queen piece = (Queen)(GD.Load<PackedScene>("res://Pieces/Queen.tscn")).Instantiate();
